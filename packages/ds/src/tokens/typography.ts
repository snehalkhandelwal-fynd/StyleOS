...
export const typography = {
  ...
  displaySm: { fontSize: 20, fontWeight: '700', lineHeight: 24, letterSpacing: -0.18 },
  titleMd: { fontSize: 16, fontWeight: '700', lineHeight: 20, letterSpacing: 0 },
  ...
  badge: { fontSize: 11, fontWeight: '700', lineHeight: 13, letterSpacing: 0 },
  ...
  navLink: { fontSize: 16, fontWeight: '700', lineHeight: 20, letterSpacing: 0 },
